...
import './mobile-calmac-blog.scss';
import '../../../../../appStyles/mobile-app-styles.scss';

interface MobileCalMacProps {
  blogPostInfo: BlogPostInfo;
  appState: AppState;
}

@observer
export class MobileCalMacBlog extends React.PureComponent<MobileCalMacProps> {
  render() {
    ...
    return (
      <div className={'mblog-post-container'}>
        <article className={'mblog-content'}>
          ...
          <p>
            As you know, our campaign to #RoamResponsibly has kicked off and we are very excited to
            introduce our first partnering organisation:{' '}
