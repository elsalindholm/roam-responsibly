...
import './mobile-surf-and-turf.scss';
import '../../../../../appStyles/mobile-app-styles.scss';

interface MobileSurfAndTurfProps {
  blogPostInfo: BlogPostInfo;
  appState: AppState;
}

@observer
export class MobileSurfAndTurfBlog extends React.PureComponent<MobileSurfAndTurfProps> {
  render() {
      ...
      <div className={'mblog-post-container'}>
        <article className={'mblog-content'}>
          ...
          <div className={'mblog-post-title-container'}>
            ...
            <p className={'mblog-post-author'}>GUEST BLOG BY: {blogPostInfo.author}</p>
          </div>
          ...
          <p>
            ...
            <a className={'mblog-link'} href={'http://tireewaveclassic.co.uk/'} target={'_blank'}>
              Tiree Wave Classic
            </a>{' '}
          ...
          <p>
            ...
            <a
              className={'mblog-link'}
              href={'https://tireemusicfestival.co.uk/'}
              target={'_blank'}
            >
