...
import './mobile-coll-blog.scss';
import '../../../../../appStyles/mobile-app-styles.scss';

interface MobileCBCProps {
  blogPostInfo: BlogPostInfo;
  appState: AppState;
}

@observer
export class MobileCollBlog extends React.PureComponent<MobileCBCProps> {
  render() {
      ...
      <div className={'mblog-post-container'}>
        <article className={'mblog-content'}>
          ...
          <p>
            ...
            by{' '}
            <a className={'mblog-link'} href={'https://ancridhe.com/'} target={'_blank'}>
              An Cridhe
            </a>{' '}
            and{' '}
            <a className={'mblog-link'} href={'https://collbunkhouse.com/'} target={'_blank'}>
              Coll Bunkhouse
            </a>{' '}
          ...
          <p>
            ...
            <a className={'mblog-link'} href={'https://www.calmac.co.uk/'} target={'_blank'}>
              CalMac Ferries
            </a>{' '}
          ...
          <p>
            ...
            <a className={'mblog-link'} href={'https://developmentcoll.org.uk/'} target={'_blank'}>
          ...
          <ul>
            ...
            <li>
              <a className={'mblog-link'} href={'http://visitcoll.co.uk/'} target={'_blank'}>
                VisitColl
              </a>
            </li>
            <li>
