      ...
      <main className={'campaign-page'}>
        <section>
          <p>
            ...
            Instagrammers signed a charter, which addressed the issues mentioned above and agreed to
            promote responsible roaming outdoors, as well as promote the Scottish Outdoor Access
            Code itself.
          </p>
        </section>
        <section>
