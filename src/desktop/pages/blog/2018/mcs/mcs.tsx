...
@observer
export class McsBlog extends React.PureComponent<McsProps> {
  render() {
        ...
        <article className={'blog-content'}>
          ...
          <div className={'mcs-text-with-img'}>
            <p>
              ...
              successfully increased awareness of marine conservation, influenced decision makers
              and published brilliant guidance like the Good Fish Guide App, which gives advice on
              sustainable seafood, recipes and where to eat out (2).
            </p>
            <div className={'blog-img , mcs-logo'}></div>
          </div>
